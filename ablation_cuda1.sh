...
for EPS in 0.0313 0.027 0.024 0.02
do
# ----------------- STAB
...
# ----------------- AutoTarget
  python main_attack.py -dataset cifar10 -robustness_level semi_robust -robust_model kang2021Stable -num_adv_examples 8000\
                        -cuda $CUDA -batch_size 128 -epsilon $EPS -num_attack_iterations 150\
                        -step_size 0.002 -attack_loss AutoTarget
  wait
  python main_attack.py -dataset cifar10 -robustness_level semi_robust -robust_model pang2022Robustness_WRN70_16 -num_adv_examples 8000\
                        -cuda $CUDA -batch_size 128 -epsilon $EPS -num_attack_iterations 150\
                        -step_size 0.002 -attack_loss AutoTarget
  wait
done
