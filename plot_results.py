...
#     #     # plot_cal_curves(path_list, figname=title)
#     #
#     #     # title = f"entropyscatter_{robustness_level}_{ds_name}"
#     #     # plot_all_scatters(path_list, figpath=f"figures/{title}.pdf")
#     #
#     #     title = f"ECE_{robustness_level}_{ds_name}"
#     #     plot_ECE(path_list, figname=title)
#     #     print("")
#
#
#
