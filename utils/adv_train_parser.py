...
__epochs_help_message = "",
__learning_rate_help_message = "",
...
__main_argument_list = [('root','experiments', None, __root_help_message),
                        ...
                        ('dropout_rate', 0.1, keys.SUPPORTED_DROPOUT_RATES, __dropout_rate_help_message),
                        ...
                        ('epsilon', keys.BASE_EPSILON, None, __epsilon_help_message),
                        ('step_size', 5e-3, None, __step_size_help_message),
                        ...
                        ('epochs', 10, None, __epochs_help_message),
                        ('lr', 1e-4, None, __learning_rate_help_message),
                        ('alpha', 1, None, __alpha_help_message),
